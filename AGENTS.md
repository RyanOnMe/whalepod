...
project311（开发代号，正式定名前一律用这一代号）：面向 3–10 人小团队的 DSH 多人协作发行版。全新仓库，不迁移 1.x 代码。
...
| 门 | 命令 | 状态 |
|---|---|---|
| Q0 静态门 | `pnpm check` | 待 P1-01 |
| Q1 单元门 | `pnpm test:unit`（领域分支覆盖 ≥95%） | 待 P1-01/02 |
| Q2 数据门 | `pnpm test:integration`（真实 PostgreSQL） | 待 P1-04 |
